    ...
    echo
        ...
        <img src="' . $image . '" alt="' . $titre .'" class="w-full h-48 object-cover">
            <div class="p-5">
                ...
                <p class="text-silver font-bold mt-3">' . $prix . ($negociable ? ' (Négociable)' : '(Non-négociable') . '</p>
                <button class="mt-4 w-full bg-silver text-blacklux py-2 rounded hover:bg-anthracite hover:text-light transition">Acheter</button>
            </div>
        </div>'
}